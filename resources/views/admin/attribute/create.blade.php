...
@section('meta_title', __('eav::attribute.create.page_meta'))
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route($routeNamePrefix.'index') }}">{{ __('eav::attribute.index.page_title') }}</a></li>
                        <li class="breadcrumb-item active">{{ __('eav::attribute.create.page_title') }}</li>
                    </ol>
                </div>
                <h4 class="page-title">{{ __('eav::attribute.create.page_subtitle') }}</h4>
            </div>
        </div>
    </div>
@endsection
