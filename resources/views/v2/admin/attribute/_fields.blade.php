...
<p id="trigger-re-render" style="display: none;"></p>
...
<div class="form-group" id="groupOptionValue" style="display: none;">
  ...
  <div class="manager-option-value table-responsive">
    <table class="table" id="tableManagerOptionValue">
      ...
      <tbody>
        @foreach(object_get($item, 'options') ?? [] as $key => $opt)
        @php($key ++)
        <tr>
          <td>
...
@push('style')
<link rel="stylesheet" href="{{ asset('vendor/eav/v2/admin/css/attribute.css') }}">
@endpush

@push('script')
<script src="{{ asset('vendor/eav/v2/admin/js/attribute.js') }}"></script>
@endpush