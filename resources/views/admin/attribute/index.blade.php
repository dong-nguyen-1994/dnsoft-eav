            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h6 class="fs-17 font-weight-600 mb-0">
                        {{ __('eav::attribute.index.page_title') }}
                    </h6>
                </div>
                <div class="text-right">
                    <div class="actions">
                        @admincan($routeNamePrefix.'create')
                            <a href="{{ route($routeNamePrefix.'create') }}" class="action-item">
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            @admincan($routeNamePrefix.'edit')
                                <a href="{{ route($routeNamePrefix.'edit', $item->id) }}" class="btn btn-success-soft btn-sm mr-1">
                                    <i class="fas fa-pencil-alt"></i>
                                </a>
                            @endadmincan

                            @admincan($routeNamePrefix.'destroy')
                                <table-button-delete url-delete="{{ route($routeNamePrefix.'destroy', $item->id) }}"></table-button-delete>
                            @endadmincan
                        </td>
                    </tr>
                @endforeach
